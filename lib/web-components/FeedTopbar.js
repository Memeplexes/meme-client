import { getActiveVoters, getDailyVotes, getTotalCreators, getTotalMemes } from "../api/api.js";
    ...
    this.innerHTML = `
      <style>
        ...
        .feed-stat {
          ...
          border: 1px solid var(--theme-blue-border-soft);
          font-size: 0.8rem;
          line-height: 1;
          cursor: help;
        }
      ...
      <div class="feed-stat" data-title="Memes is the total amount of memes in the system." title="Memes is the total amount of memes in the system." aria-label="Memes is the total amount of memes in the system.">
      ...
      <div class="feed-stat" data-title="Creators is the total amount of unique meme creators in the system." title="Creators is the total amount of unique meme creators in the system." aria-label="Creators is the total amount of unique meme creators in the system.">
      ...
      <div class="feed-stat" data-title="Votes is the current daily 24 vote count." title="Votes is the current daily 24 vote count." aria-label="Votes is the current daily 24 vote count.">
      ...
      <div class="feed-stat" data-title="Active is the amount of active users in the past 24 hours." title="Active is the amount of active users in the past 24 hours." aria-label="Active is the amount of active users in the past 24 hours.">
