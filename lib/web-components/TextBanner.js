...
class TextBanner extends HTMLElement {
  ...
  constructor() {
    ...
    this.shadowRoot.innerHTML = `
      <style>
        ...
        .track.scroll {
          ...
          animation-play-state: var(--text-banner-play-state, running);
        }
    ...
    this.addEventListener('mouseover', this._pauseAnimation);
    this.addEventListener('mouseout', this._resumeAnimation);
  }
  ...
  _pauseAnimation = () => {
    this._track.style.setProperty('--text-banner-play-state', 'paused');
  };

  _resumeAnimation = () => {
    this._track.style.setProperty('--text-banner-play-state', 'running');
  };
  ...
  _updateAnimation() {
    ...
    this._track.style.removeProperty('--text-banner-play-state');
