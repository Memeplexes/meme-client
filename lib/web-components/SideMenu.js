    ...
    this.#shadow.innerHTML = `
      <style>
        ...
        .trending-tag:focus-visible {
          ...
          border-color: var(--theme-white-24);
        ...
        .trending-tag-count {
          min-width: 24px;
          border-radius: 999px;
          background: var(--theme-slate-400-28);
          padding: 2px 8px;
          font-size: 12px;
          text-align: center;
        ...
        @media (max-width: 767px) {
          ...
          .side-menu-toggle {
            ...
            border: 1px solid var(--theme-border-medium-strong);
            border-radius: 999px;
            background: var(--theme-surface-panel-overlay);
            color: var(--theme-text-primary);
            font-size: 32px;
            line-height: 1;
            cursor: pointer;
          ...
          .side-menu {
            ...
            box-shadow: 14px 0 40px var(--theme-shadow-strong);
          }
