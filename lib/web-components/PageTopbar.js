...
AUTH_URL = "https://api.memeplexes.com/api/meme/login"; // override for testing against prod server, make sure to set this in your worker's environment variables as well if you want to test admin routes
