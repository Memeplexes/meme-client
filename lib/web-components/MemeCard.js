  ...
  #initialize() {
    ...
    if (!MemeCard.#stylesInjected) {
      ...
      style.textContent = `
        meme-card.meme #meta-overlay {
          ...
          opacity: 0;
          bottom: var(--meta-overlay-bottom);
        ...
        body[data-view="list"] meme-card.meme #meta-overlay {
          ...
          opacity: 0.88;
          background: linear-gradient(rgba(35, 35, 35, 0.98), rgba(18, 18, 18, 0.98));
        }
    ...
    for (const tag of tags) {
      ...
      const onTagMouseEnter = () => {
        ...
        // tagButton.style.textDecoration = "underline";
      };
      ...
      this._cleanup.push(() => tagButton.removeEventListener("mouseenter", onTagMouseEnter));
      this._cleanup.push(() => tagButton.removeEventListener("mouseleave", onTagMouseLeave));
