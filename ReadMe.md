...
It's really easy to update the UI.

There is just a single `index.html` file, no need to `npm install garbage`

Just clone the project and edit the `index.html` file

You can use `vite dev` to localhost, etc
